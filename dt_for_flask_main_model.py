...
def predict_value(video_values):
	...
	y_pred = clf_gini.predict([video_values[2:15]])
	print(y_pred[0])
	return y_pred[0]

#predict_value(['name', 'id', 11,48,0.007,0.129,0.008,0.006,0.85,1.05,8.41,18355.46,20199.77,19891.31,0.4036138363, 'rq'])
#predict_value(['actual name_2.mp4', 'IMG_1342.mp4', 11, 25, 0.0, 0.526, 0.027, 0.444, 0.002, 1.4, 8.11, 7219.25, 7604.5, 8548.0, 0.20183182722518778, -1, 21])
