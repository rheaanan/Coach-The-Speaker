...
X = balance_data.values[:, 2].reshape(-1, 1)
...
for i in range(100):
    ...
    if err > max_acc_err:
        max_y_pred = y_pred
        joblib.dump(clf_gini,"questions_dt_gini.pkl")
        max_acc_err = err
tree.export_graphviz(clf_gini,out_file="questionstree_gini.dot")
#print("devs",devs)
...
for i in range(0, 10):
	...
	#print("final_value:",(rms/len(predicted_list)))
